    ...
    public SecurityFilterChain securityFilterChain(
        ...
        return http
            ...
            .authorizeHttpRequests(authorize -> authorize
                ...
                .requestMatchers(HttpMethod.GET, "/api/catalogos/facultades/activas").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/catalogos/carreras/activas").permitAll()
                ...
                .requestMatchers(HttpMethod.POST, "/api/usuarios/*/perfiles/estudiante").authenticated()
                .requestMatchers(HttpMethod.PUT,  "/api/usuarios/*/perfiles/estudiante").authenticated()
                .requestMatchers(HttpMethod.GET,  "/api/usuarios/*/perfiles/estudiante").authenticated()
                .requestMatchers(HttpMethod.POST, "/api/usuarios/*/perfiles/estudiante/doble-titulaciones").authenticated()
                .requestMatchers(HttpMethod.DELETE, "/api/usuarios/*/perfiles/estudiante/doble-titulaciones/*").authenticated()
                .requestMatchers(HttpMethod.GET,  "/api/usuarios/*/perfiles/estudiante/doble-titulaciones").authenticated()
                .requestMatchers(HttpMethod.POST, "/api/usuarios/*/perfiles/participante-externo").authenticated()
